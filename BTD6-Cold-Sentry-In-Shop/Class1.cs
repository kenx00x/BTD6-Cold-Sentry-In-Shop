...
using MelonLoader;
using System.IO;
[assembly: MelonInfo(typeof(BTD6_Cold_Sentry_In_Shop.Class1), "Cold Sentry In Shop", "1.1.0", "kenx00x")]
...
namespace BTD6_Cold_Sentry_In_Shop
{
    public class Class1 : MelonMod
    {
        ...
        {
            MelonLogger.Log("Cold Sentry In Shop mod loaded");
        ...
        public class ProfileModel_Patch
        {
            ...
            public static void Postfix(ProfileModel __instance)
            {
                ...
                {
                    MelonLogger.Log("Cold Sentry already unlocked");
                }
                else
                {
                    MelonLogger.Log("unlocking Cold Sentry");
